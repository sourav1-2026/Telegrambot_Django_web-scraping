...
API_KEY = '1802863188:AAFoI_jDv0Tgee38FvOuJ9q8ewjQ3IkuNhE'
    ...
    if num_there(text):
        if isValidPinCode(text):
            ...
            for cowin_obj in cowin_objs:
                message += f"""{i}) Place:{cowin_obj.name}\n fee_type:{cowin_obj.fee_type}\n fee:{cowin_obj.fee}\n available_capacity: {cowin_obj.available_capacity} \n available_capacity_dose1: {cowin_obj.available_capacity_dose1}\n available_capacity_dose2: {cowin_obj.available_capacity_dose2}\n min_age_limit:{cowin_obj.min_age_limit}\n vaccine:{cowin_obj.vaccine} \n \n """
                i+=1
